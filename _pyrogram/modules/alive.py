...
**Alive**
  ...
  `alive -p` -> __For Checking Pyrogram Alive Status__
  `alive -t` -> __For Checking Telethon Alive Status__
  `ping -p` -> __For Pinging Pyrogram__
  `ping -t`  -> __For Pinging Telethon__
"""
    }
)
...
async def alive(_, m):
    ...
    reply_msg = f"**[Developer](https://github.com/shamilhabeebnelli/Dev-Guard)**\n"
